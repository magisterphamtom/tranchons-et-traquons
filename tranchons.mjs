...
import { AventurierData } from "./module/data/actor-aventurier.mjs";
import { PnjData }        from "./module/data/actor-pnj.mjs";
import { AvantageData, FaiblesseData, DonData, ArmeData, EquipementData } from "./module/data/items.mjs";
...
Hooks.once("init", () => {
  ...
  CONFIG.Actor.dataModels = {
    aventurier: AventurierData,
    pnj:        PnjData,
  };
  CONFIG.Item.dataModels = {
    avantage:   AvantageData,
  ...
  // Enregistrement des sheets avec les nouvelles API V13
  foundry.documents.collections.Actors.unregisterSheet("core", foundry.appv1.sheets.ActorSheet);
  foundry.documents.collections.Actors.registerSheet("tranchons-et-traquons", TnTActorSheet, {
  ...
  foundry.documents.collections.Items.registerSheet("tranchons-et-traquons", TnTItemSheet, {
    makeDefault: true,
