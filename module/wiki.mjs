...
export class TnTWiki extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  static CONTENT = {
      ...
      sections: [
        {
          ...
          texte: "Depuis la barre latérale 'Personnages' (icône personnes), un bouton vert 'Créer un aventurier T&T' ouvre l'assistant en 5 étapes : Peuple (12 choix avec don + destin), Classe (6 choix avec trait clé), Traits via la méthode Folle Jeunesse (4 jets de tables + 5 points libres), Détails (nom, âge, signe, réflexe, avantage, faiblesse), puis Récapitulatif. L'aventurier est créé automatiquement avec tous ses items.",
        },
        {
          titre: "🖼 Portrait",
    ...
    guide_mj: {
      ...
      sections: [
        {
          titre: "🎲 Création de personnage guidée",
          texte: "Le bouton vert 'Créer un aventurier T&T' dans la sidebar Personnages lance un assistant 5 étapes. Les joueurs tirent leurs traits via la méthode Folle Jeunesse (4 tables 1D6 + 5 points libres). L'aventurier est créé directement dans Foundry avec sa fiche complète, son avantage de départ et sa faiblesse de classe.",
        },
        {
          titre: "⚡ Initiative",
